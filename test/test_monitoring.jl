...
function analytical_contribution(t::T2, traj::Trajectory{T2,T3}, gamma::T2, n::T3) where {T2<:Real,T3<:Int}
...
@testset "Trajectory Contributions: Trajectory Methods" begin
    ############# System Definition
    NLEVELS = 5
